...
<a href="{{ route('transaksi.create') }}" class="btn btn-primary mb-3" style="background-color: #424242; color: white;">Tambah Transaksi</a>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('transaksi.edit', $trx->id) }}" class="btn mr-2 rounded-circle py-2"
                        style="background-color: rgb(173, 173, 173);"><i class="fas fa-fw fa-pen text-white"></i></a>
                    ...
                    <a href="{{ url('/dashboard/laporan-transaksi/'. $trx->kode_invoice) }}" class="btn ml-2 rounded-circle py-2"
                        style="background-color: rgb(117, 117, 117);"><i class="fas fa-fw fa-print text-white"></i></a>
                </div>
            </td>
        </tr>
        @endforeach
